...
extension PhoneVerificationController: CountryPickerDelegate {
	...
	public func countryPhoneCodePicker(_ picker: CountryPicker, didSelectCountryWithName name: String, countryCode: String, phoneCode: String, flagEmoji: String) {
		phoneCountryField.text = phoneCode
		phoneCoutryEmoji.text = flagEmoji
